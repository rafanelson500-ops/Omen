...
BAR_LEVEL_CSV = BACKEND / "data" / "analysis" / "bar_level_returns.csv"
REPORT_MD = BACKEND / "diagnostics" / "bar_level_sharpe" / "REPORT.md"

SANITY_TOL = 0.05  # 5%

# Reference numbers from prior diagnostics (for the comparison table)
TRADE_LEVEL_DAILY_SHARPE = 4.45
PER_TRADE_ANNUALIZED_SHARPE = 5.13
PER_TRADE_RAW_SHARPE = 0.2193
TRADE_COUNT = 174
MEAN_TRADE_PNL = 141.66
TRADE_WIN_RATE = 0.4885
