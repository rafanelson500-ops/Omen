...
INPUT_CSV = BACKEND / "data" / "analysis" / "oos_baseline_trades_2025-09-08_2025-12-23.csv"
OUTPUT_DIR = BACKEND.parent / "diagnostics" / "oos_75d_baseline"
OUTPUT_MD = OUTPUT_DIR / "dsr_oos_report.md"

T_TRADES = 158
N_SESSIONS = 76
TRIALS_DEFAULT = 2
TRIALS_SENSITIVITY = (2, 3, 5, 10, 20)
