...
export class Rectangle extends PluginBase {
	...
	constructor(
		...
		// Only create axis pane views if showAxisHighlights is true
		this._priceAxisPaneViews = this._options.showAxisHighlights 
			? [new RectanglePriceAxisPaneView(this, true)] 
			: [];
		this._timeAxisPaneViews = this._options.showAxisHighlights 
			? [new RectangleTimeAxisPaneView(this, false)] 
			: [];
	}
