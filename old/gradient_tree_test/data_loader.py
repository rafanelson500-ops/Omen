"""
Data loader for BOIL ticker historical data.
...
def load_boil_data(period: str = "60d", start: Optional[str] = None, end: Optional[str] = None, interval: str = "1h") -> pd.DataFrame:
    """
    Load historical data for BOIL ticker.
    
    Args:
        period: Valid periods: 1d, 5d, 1mo, 3mo, 6mo, 1y, 2y, 5y, 10y, ytd, max
               For hourly data, use shorter periods like 60d (60 days)
